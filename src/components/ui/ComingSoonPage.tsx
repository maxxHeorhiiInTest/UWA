...
export async function ComingSoonPage({
  ...
  return (
    <section className="relative overflow-hidden bg-uwa-black px-4 py-12 sm:py-24">
      <div
      ...
      <div className="relative mx-auto flex max-w-5xl flex-col items-center text-center">
        ...
        <h1 className="mt-6 font-heading text-3xl tracking-wide text-uwa-white sm:text-5xl">
          {title}
        </h1>
